...
function gs_queue_js_and_css() {
  ...
  // include modernizr in the head
    wp_register_script( 'modernizr', get_template_directory_uri() . '/js/libs/modernizr-2.5.2.min.js', array(), '2.5.2', false );
    ...
    wp_register_script( 'gs-scripts', get_template_directory_uri() . '/js/scripts.js', array( 'modernizr', 'jquery' ), '2012-03-09T10:15', true );
    wp_enqueue_script( 'gs-scripts' );

	// Register main stylesheet
    wp_register_style( 'gs-styles', get_template_directory_uri() . '/style.css', array(), '2012-03-09T10:15', 'all' );
